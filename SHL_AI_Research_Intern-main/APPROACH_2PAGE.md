...
This document outlines the approach for building an intelligent SHL Assessment Recommendation System using semantic search with embeddings and LLM-based reranking. The system improved Mean Recall@10 from 0.15 to 0.75 through iterative optimization, providing balanced recommendations across technical and behavioral assessment domains.
